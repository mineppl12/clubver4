...
function ManageApplications() {
  ...
  async function init() {
    try {
      ...
      const data = await getData(
        "https://points.jshsus.kr/api/clubs/applications",
        { sessionID }
      );
      const myClubs = await getData(
        "https://points.jshsus.kr/api/clubs/manage",
        { sessionID }
      );
  ...
  async function postApplication(applyId, newStatus) {
    ...
    const res = postData(`https://points.jshsus.kr/api/clubs/applications`, {
